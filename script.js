const buttons = [...document.querySelectorAll('.profile__activity-option')]
let data = []
...
const clearActivities = () => {
    ...
    const activities = document.querySelectorAll('.activity__cards')
...
const renderCards = (clickedOption) => {
    ...
    data.forEach(activity => {
        ...
        section.classList.add('activity__cards', activityClass)
        ...
        dashboardContainer.append(section)
    })
};
